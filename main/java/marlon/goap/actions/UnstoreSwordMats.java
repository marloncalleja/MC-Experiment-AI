...
public class UnstoreSwordMats extends Action{
	
	public UnstoreSwordMats(){			
		addEffect("hasSwordMats", true);
		setWorldPosition();
		this.fixedCost = 5;	
		enable = true;
	}		
	...
	public List<AIStrategy> strategy()
	{
		...
		list.add(new UnstoreStrategy(new Wishlist(new InventoryDefinition(("[{slotIndex: 0, amount: 2, itemId: 265, damageValue: 1}]")))));
