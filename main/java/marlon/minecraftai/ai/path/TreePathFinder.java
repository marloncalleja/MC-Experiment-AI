...
import marlon.minecraftai.ai.task.DestroyInRangeTask;
import marlon.minecraftai.ai.task.DestroyLogInRange;
...
import marlon.minecraftai.ai.task.move.HorizontalMoveTask;
import marlon.minecraftai.ai.task.move.JumpMoveTask;
import marlon.minecraftai.ai.task.place.PlantSaplingTask;
import marlon.minecraftai.ai.utils.BlockCounter;
import marlon.minecraftai.ai.utils.BlockCuboid;
import marlon.minecraftai.build.block.WoodType;
...
//				}
	...
	/**
	 * This is a special override that allows us to add tasks for the large
	 * tree without requiring to pathfind. FIXME: Find a nicer, uniform
	 * solution.
	 * 
	 * @return
	 */
