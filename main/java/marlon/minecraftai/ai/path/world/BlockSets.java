package marlon.minecraftai.ai.path.world;
...
public class BlockSets {
	...
	public static final BlockSet WOOL = new BlockSet(Blocks.wool); //added Marlon.C
	
	public static final BlockSet IRONORE = new BlockSet(Blocks.iron_ore); //added Marlon.C
