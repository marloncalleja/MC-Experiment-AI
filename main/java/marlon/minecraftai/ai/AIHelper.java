...
import marlon.minecraftai.ai.input.KeyboardInputController;
import marlon.minecraftai.ai.input.KeyboardInputController.KeyType;
import marlon.minecraftai.ai.net.NetworkHelper;
import marlon.minecraftai.ai.path.world.BlockBounds;
...
import marlon.minecraftai.ai.utils.RandUtils;
import marlon.minecraftai.build.BuildManager;
import marlon.minecraftai.map.MapReader;
import marlon.minecraftai.settings.MinebotSettings;
import marlon.minecraftai.settings.SaferuleSettings;
import marlon.minecraftai.stats.StatsManager;
...
public abstract class AIHelper {
	...
	public void overrideAttack() {  
		...
		mc.gameSettings.keyBindAttack = new InteractAlways( //Edited Marlon.C, player was not attacking target
