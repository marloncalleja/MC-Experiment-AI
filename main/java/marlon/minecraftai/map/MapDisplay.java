...
import marlon.minecraftai.map.MapReader.ImagePos;
import marlon.minecraftai.map.MapReader.MultiModeImage;
import marlon.minecraftai.map.MapReader.WriteableImage;
import marlon.minecraftai.map.PlayerPositionLabel.FollowPlayerListener;
